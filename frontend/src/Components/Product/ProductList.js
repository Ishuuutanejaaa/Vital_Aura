...
const ProductList = () => {
    ...
    // Updated products array with adjusted prices and three new medicines
    const products = [
        {
        ...
        {
            image: 'Atorvastatin.jpeg',
            title: 'Atorvastatin',
            price: '₹75.00',
            description: 'Cholesterol reducer',
        },
        {
            image: 'Ranitidine.jpeg',
            title: 'Ranitidine',
            price: '₹35.00',
            description: 'Acidity relief',
        },
        {
            image: 'Loratadine.jpeg',
            title: 'Loratadine',
            price: '₹20.00',
            description: 'Allergy relief',
        },
        ...
        {
            image: 'Omeprazole.jpeg',
            title: 'Omeprazole',
            price: '₹25.00',
            description: 'Acid reflux relief',
        },
        {
            image: 'Vitamin D3.jpeg',
            title: 'Vitamin D3',
            price: '₹120.00',
            description: 'Bone health',
        },
        {
            image: 'Calcium Carbonate.jpeg',
            title: 'Calcium Carbonate',
            price: '₹90.00',
            description: 'Calcium supplement',
        },
        {
            image: 'Cough Syrup.jpeg',
            title: 'Cough Syrup',
            price: '₹70.00',
            description: 'Cough relief',
        },
        {
            image: 'Multivitamins.jpeg',
            title: 'Multivitamins',
            price: '₹150.00',
